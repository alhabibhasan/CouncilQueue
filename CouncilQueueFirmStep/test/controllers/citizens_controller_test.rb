...
class CitizensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citizen" do
    assert_difference('Citizen.count') do
      post citizens_url, params: { citizen: { firstname: @citizen.firstname, lastname: @citizen.lastname, title: @citizen.title } }
    end
  ...
  test "should update citizen" do
    patch citizen_url(@citizen), params: { citizen: { firstname: @citizen.firstname, lastname: @citizen.lastname, title: @citizen.title } }
